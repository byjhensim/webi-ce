...
class SettingsHandler {
  ...
  setDefaultSettings(defaultSettings) {
      ...
      for (const setIdx in settings) {
        ...
        if (setProperty.includes("/")) {
          ...
          if (typeof fontProperty[property[1]] ==  "undefined") {
            console.log("Setting Error: Font setting id " + property[1] + " does not exist");
          }
          ...
          if (!this.mapSettings.has(property[0])) {
            console.log("Setting Error: Setting id " + property[0] + " is not in default settings");
          }
          ...
          const value = settings[setIdx].value;
          this.mapSettings.set(setProperty, typeof value === "undefined" ? "" : value);
        }
      }
    }
    ...
    getAsColor(id) {
      return this.mapSettings.get(id) !== "" ? this.mapSettings.get(id) : null;
    }
